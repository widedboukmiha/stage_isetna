...
namespace stage_isetna
{
    ...
    partial void DeleteEtudiant(Etudiant instance);
		...
		public DataClasses2DataContext() : 
				base(global::stage_isetna.Properties.Settings.Default.DatabaseConnectionString, mappingSource)
		{
			OnCreated();
		}
    ...
    partial void OnAnneeUnivChanging(string value);
    partial void OnAnneeUnivChanged();
    ...
    partial void OnGroupIdChanged();
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_Cin", DbType="VarChar(MAX)")]
		public string Cin
		{
			get
			{
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_CodePostal", DbType="VarChar(MAX)")]
		...
		[global::System.Data.Linq.Mapping.ColumnAttribute(Storage="_AnneeUniv", DbType="VarChar(MAX)")]
		public string AnneeUniv
		{
			get
			{
				return this._AnneeUniv;
			}
			set
			{
				if ((this._AnneeUniv != value))
				{
					this.OnAnneeUnivChanging(value);
					this.SendPropertyChanging();
					this._AnneeUniv = value;
					this.SendPropertyChanged("AnneeUniv");
					this.OnAnneeUnivChanged();
				}
			}
		}
